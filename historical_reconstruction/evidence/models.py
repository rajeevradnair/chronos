...
class EvidenceRecord(BaseModel):
    ...
    def validate_granularity(self):
        if self.evidence_granularity == "chunk" and not self.chunk_id:
            raise ValueError("chunk evidence requires chunk_id")

        if self.evidence_granularity == "document" and self.chunk_id is not None:
            raise ValueError("document evidence requires chunk_id=None")
